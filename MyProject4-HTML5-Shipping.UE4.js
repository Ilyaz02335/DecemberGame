...
//	}
	...
	function withIndexedDB(db) {
		...
		var mainCompiledCode = fetchFromIndexedDB(db, 'wasmModule').then(function(wasmModule) {
			...
			return download(Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/c5xhpgmw5ut86wfgn66ah/MyProject4-HTML5-Shipping.wasm?rlkey=ahp2k6b6t1qvzi3fg99m14n2c&dl=0'), 'arraybuffer').then(function(wasmBytes) {
